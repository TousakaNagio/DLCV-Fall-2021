...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, pos_embed, tgt, tgt_mask):
        ...
        hs, attn_maps = self.decoder(tgt, memory, memory_key_padding_mask=mask, tgt_key_padding_mask=tgt_mask,
                          pos=pos_embed, query_pos=query_embed,
                          tgt_mask=generate_square_subsequent_mask(len(tgt)).to(tgt.device))
        # print(type(attn_maps), 'transformer')
        return hs, attn_maps
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        # print(type(attn_map), 'transformerdecoder')
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_pre(self, tgt, memory,
        ...
        tgt = tgt + self.dropout1(tgt2)
        tgt2 = self.norm2(tgt)
        tgt2, self.attn_map = self.multihead_attn(query=self.with_pos_embed(tgt2, query_pos),
                                   key=self.with_pos_embed(memory, pos),
                                   value=memory, attn_mask=memory_mask,
        ...
        tgt = tgt + self.dropout3(tgt2)
        # print(self.attn_map.size())
        return tgt, self.attn_map
